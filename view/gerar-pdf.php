...
$API = new consumo_api;
$projeto= new projeto;
$mpdf=new mPDF('c', 'A4', '', '', 30, 20,35,20);     
...
if ($acao && $idItem && $idSessao) {
    if ($acao == 'selecionarSessaoItem') {
                ...
                <html>
                    <body>
                        <div style='margin: 0 auto;'>
                          <img src='/interno/sisproj/assets/img/ayume.png' style=' width:300px;margin-left: 150px;'>

                          <h3 style='margin-top:100px; text-align:justify'>$lista->titulo</h3>
                        </div>
                    </body>
                </html>
                ";
        ...
        $header = '
            ...
            <td width="33%" align="center"><img src="/interno/sisproj/assets/img/ayume.png" width="70px" /></td>
